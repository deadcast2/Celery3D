# Celery3D GPU - DDR3 Memory Test Build Script
# Target: Xilinx Kintex-7 XC7K325T-2FFG900C (KC705 Evaluation Board)
# Usage: vivado -mode batch -source scripts/synth_ddr3_test.tcl

puts "=============================================="
puts "Celery3D - DDR3 Memory Test Build"
puts "=============================================="

# Configuration
set part xc7k325tffg900-2
set output_dir ./build_ddr3
set top_module ddr3_test_top
set project_name ddr3_test
...
# DDR3 test constraints (LEDs, reset)
add_files -fileset constrs_1 -norecurse constraints/ddr3_test.xdc
...
set bitstream_dst "$output_dir/ddr3_test.bit"
...
puts "Output Files:"
puts "=============================================="
puts "  Bitstream: $output_dir/ddr3_test.bit"
...
puts "=============================================="
puts ""
puts "To program: make program-ddr3"
puts "=============================================="
